---
sidebar_position: 4
title: 'Deep Dive: ML Algorithms Explained with Analogies'
sidebar_label: 'Deep Dive (Part 2)'
---

# Deep Dive — ML Algorithms Explained with Analogies
...
How the algorithm choice changes inference cost, memory footprint and latency, which is what makes it an operational decision rather than only a modelling one.
